...
function ApplicationViewPage() {
  ...
  const queryParams = useMemo<{ include: { job_posting: boolean; employee: boolean } }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['job_posting', 'employee'],
          id,
        },
        'application',
      ),
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Date Applied"
                  text={data?.date_applied ? format(data?.date_applied, 'dd-MM-yyyy') : ''}
                />
