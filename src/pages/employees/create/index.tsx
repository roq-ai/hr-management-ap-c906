...
function EmployeeCreatePage() {
  ...
  const formik = useFormik<EmployeeInterface>({
    initialValues: {
      ...
      position: '',
      department: '',
      date_hired: new Date(new Date().toDateString()),
      salary: 0,
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="date_hired" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Date Hired
            </FormLabel>
            <DatePicker
              selected={formik.values?.date_hired ? new Date(formik.values?.date_hired) : null}
              onChange={(value: Date) => formik.setFieldValue('date_hired', value)}
            />
          </FormControl>
